class ShowcaseController < ApplicationController
  def index
    ...
    @photos_carpet = [{title: 'photo', url: 'carpet_1_thumb.jpg' }, {title: 'photo', url: 'carpet_2_thumb.jpg' }, {title: 'photo', url: 'carpet_3_thumb.jpg' }, {title: 'photo', url: 'rolling_carpet.jpg'}, {title: 'photo', url: 'justin_sales.jpg'}]
  end
